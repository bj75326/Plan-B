            ...
            <div className="page subpage">
                ...
                <div className="viewport">
                    <CellGroup title="向左滑动单元格出现功能按键，点击触发事件" style={{marginTop: '11px'}}>
                        <CellGroup.Cell titleText="Item-1" right={rightBtnGroup} />
                        <CellGroup.Cell titleText="Item-2" right={rightBtnGroup} />
                        <CellGroup.Cell titleText="Item-3" right={rightBtnGroup} />
                    </CellGroup>
                    <CellGroup title="向右滑动单元格出现功能按键，点击触发事件">
                        <CellGroup.Cell titleText="Item-1" left={leftBtnGroup}/>
                        <CellGroup.Cell titleText="Item-2" left={leftBtnGroup}/>
                        <CellGroup.Cell titleText="Item-3" left={leftBtnGroup}/>
                    </CellGroup>
